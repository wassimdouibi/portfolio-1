...
const Footer = () => {
  ...
  return (
    <footer
      className="w-full pt-20 pb-10 relative bg-white dark:bg-black-100"
      id="contact"
    >
              ...
              <div className="flex-1 p-6 md:p-10 space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="border-4 border-black dark:border-white p-6 bg-white dark:bg-black-200 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
                    <h3 className="text-2xl font-black mb-4 uppercase tracking-tight text-black dark:text-white">
                      E-mail
                    </h3>
                    <p className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-6 leading-tight">
                      My email is available at all times, so feel free to
                      contact me anytime!
                    </p>
                    <button
                      onClick={handleCopy}
                  ...
                  <div className="border-4 border-black dark:border-white p-6 bg-white dark:bg-black-200 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
                    ...
                    <p className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-6 leading-tight">
                      I am available based on the calendar, don&apos;t hesitate
                      to book during that time!
                    </p>
                    <a
          ...
          <div className="flex items-center gap-6">
            {socialMedia.map((info) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group w-14 h-14 border-4 border-black dark:border-white bg-white dark:bg-black flex justify-center items-center hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[6px_6px_0px_0px_rgba(255,255,255,1)] hover:bg-gradient-to-r hover:from-[#FFB700] hover:via-[#FF8C00] hover:to-[#FF006E] hover:border-transparent"
              >
                <img
                  src={info.img}
                  alt="social-icon"
                  width={28}
                  height={28}
                  className="invert dark:invert-0 group-hover:invert-0"
                />
              </a>
            ))}
          </div>
